...
char* firstrelay = "/home/gf/br/r1";
char* secondrelay = "/home/gf/br/r2";
char* devicetest = "/home/gf/br/ping";
...
void sensordata(){
  ...
  client.publish("/home/gf/br/temp", charBuf);
  ...
  client.publish("/home/gf/br/light",charBuf);
  delay(3000);
}
...
void callback(char* topic, byte* payload, unsigned int length) {
  ...
  if(payload[0] == '1'){
      ...
      else if(topicStr == devicetest)
     {
      ...
      client.publish("/home/gf/br/ping/confirm", "1");
     }
     
     else
     {
       digitalWrite(in2, LOW);
       client.publish("/home/gf/br/r2/confirm", "on");
     }
   ...
   if(payload[0] == '0'){
     ...
     {
      digitalWrite(in1, HIGH);
       client.publish("/home/gf/br/r1/confirm", "off");
     }
     else
     {
       digitalWrite(in2, HIGH);
       client.publish("/home/gf/br/r2/confirm", "off");
     }
